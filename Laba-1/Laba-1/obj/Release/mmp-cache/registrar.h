...
@interface ViewController : NSViewController {
	...
	@property (nonatomic, assign) NSButton * DeleteBtn;
	@property (nonatomic, assign) NSButton * DownBtn;
	@property (nonatomic, assign) NSTableView * TAb;
	@property (nonatomic, assign) NSButton * UpBtn;
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
	-(bool) xamarinSetGCHandle: (GCHandle) gchandle flags: (enum XamarinGCHandleFlags) flags;
...
@interface Laba1_TableDataSource : NSObject<NSTableViewDataSource> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
